...
const Footer = () => {
    ...
    const [content, setContent] = useState(getContent().footer);

    useEffect(() => {
        const updateContent = () => {
            setContent(getContent().footer);
        };
        updateContent();
            ...
            <div className="footer-container">
                <div className="footer-content">
                    ...
                    <motion.div variants={itemVariants} className="footer-section">
                        <h3 className="footer-logo">KEVINA</h3>
                    ...
                    <motion.div variants={itemVariants} className="footer-section">
                        ...
                        <p className="footer-text">{content.newsletterText}</p>
                ...
                >
                    ...
                    <p className="footer-location">{content.location}</p>
                </motion.div>
            </div>
        </motion.footer>
    );
